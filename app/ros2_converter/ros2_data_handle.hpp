...
#include <fm_dev_driver/msg/begin_pair.hpp>
#include <fm_dev_driver/msg/cancel_pair.hpp>
#include <fm_dev_driver/msg/data_user_to_user.hpp>
#include <fm_dev_driver/msg/dis.hpp>
...
private:
  ...
  rclcpp::Publisher<fm_dev_driver::msg::SphericalResult>::SharedPtr
      spherical_result_pub_;
  rclcpp::Publisher<fm_dev_driver::msg::PrevSphericalResult>::SharedPtr
      prev_spherical_result_pub_;
  rclcpp::Publisher<fm_dev_driver::msg::Dis>::SharedPtr dis_pub_;
  ...
  rclcpp::Subscription<fm_dev_driver::msg::CancelPair>::SharedPtr
      cancel_pair_sub_;
  rclcpp::Subscription<fm_dev_driver::msg::DataUserToUser>::SharedPtr
